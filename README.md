...
* 전체적인 퀘스트 시스템은 구현했습니다. 컨텐츠는 없는 상태이지만 기능적으로 작동하는 것을 확인하였습니다.  

* 퀘스트 시스템에 필요한 UI 요소 제작중입니다.  

* 전체적으로 모양이 잡히면 세이브 시스템 작업 예정입니다.  
...
* Player 내부에 있는 UI를 밖으로 빼내오는 작업 ~~필요~~ 완료

**2024\. 3\. 22\. ~ 4\. 2\.**  

* 코드 리팩토링 작업

* 오디오 오류 및 비디오 오류 수정 완료

* 전체적, 상황별 사운드 균형 조절

* 내부 디자인 보강

* 1인칭/3인칭 토글 카메라 기능 추가

* 대화시스템 개선

* 타임라인 연출을 개선된 대화시스템에 맞게 수정  

* 카메라 회전 기능 추가 >> 조금 불편한 부분 있어서 수정 필요

* 부스 내부 충돌처리

* 코드 작업하면서 발생한 버그 일괄 수정
