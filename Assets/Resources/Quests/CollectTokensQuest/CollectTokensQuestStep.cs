...
namespace Jinsol
{
    public class CollectTokensQuestStep : QuestStep
    {
        ...
        public int tokensRequired = 9; // 취업/입학상담 부스를 제외하고 토큰 하나씩. 남은 하나는 맨 처음에 NPC에게 퀘스트 진행을 하겠다고 말하면 얻게 됨: 이유는 인생에 있어서 큰 용기를 내서 큰 선택을 했기 때문.
        ...
        private void TokenCollected()
        {
            ...
            {
                tokensCollected = tokensRequired;
